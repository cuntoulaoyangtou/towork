...
public class UserInfo {
    ...
    public UserInfo(Integer uid, String username, String phone, String uno, Integer age, Boolean sex, String address, String department, String grade, String avatar, Integer face_id) {
        this.uid = uid;
