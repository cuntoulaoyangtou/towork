package com.java.toworkservice.utils;
...
public class FileUtil {
    ...
    static  {
        fileStorageLocation = Paths.get(Constants.FILE_UPLOAD_DIR).toAbsolutePath().normalize();
        try {
    ...
    public static String storeFile(MultipartFile file) {
        ...
        fileName = Constants.JWT_ID+new Date().getTime()+"_"+(int)(Math.random()*100)+fileName.substring(fileName.lastIndexOf("."),fileName.length());
        try {
